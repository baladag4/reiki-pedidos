...
-- Alguns pedidos de teste
INSERT INTO pedidos_reiki (nome_solicitante, data_nascimento_solicitante, quantidade_pessoas, necessidade, status) VALUES
('Maria Silva', '1980-05-15', 2, 'Pedido de saúde e paz para minha família', 'pendente'),
('João Santos', '1975-08-20', 1, 'Proteção espiritual e clareza mental', 'pendente'),
('Ana Costa', '1990-03-10', 5, 'Harmonia familiar e prosperidade', 'concluido');

-- Pessoas atendidas para o pedido 1 (Maria Silva - 2 pessoas)
INSERT INTO pessoas_atendimento (pedido_id, nome, data_nascimento, cidade, ordem) VALUES
(1, 'Maria Silva', '1980-05-15', 'São Paulo', 1),
(1, 'Pedro Silva', '1978-12-03', 'São Paulo', 2);

-- Pessoas atendidas para o pedido 2 (João Santos - 1 pessoa)
INSERT INTO pessoas_atendimento (pedido_id, nome, data_nascimento, cidade, ordem) VALUES
(2, 'João Santos', '1975-08-20', 'Rio de Janeiro', 1);

-- Pessoas atendidas para o pedido 3 (Ana Costa - 5 pessoas)
INSERT INTO pessoas_atendimento (pedido_id, nome, data_nascimento, cidade, ordem) VALUES
(3, 'Ana Costa', '1990-03-10', 'Belo Horizonte', 1),
(3, 'Carlos Costa', '1988-07-22', 'Belo Horizonte', 2),
(3, 'Julia Costa', '2015-11-05', 'Belo Horizonte', 3),
(3, 'Rosa Maria', '1960-01-30', 'Belo Horizonte', 4),
(3, 'José Costa', '1955-09-14', 'Belo Horizonte', 5);
...
-- 2. Remova os dados de teste se desejar
-- 3. Configure as permissões da pasta 'uploads'
-- 
-- ============================================
